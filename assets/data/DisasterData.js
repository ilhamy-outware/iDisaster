export default {
    tornado: {
      name: "Tornado",
      "description": "Tornadoes can destroy buildings, flip cars, and create deadly flying debris.Tornadoes are violently rotating columns of air that extend from a thunderstorm to the ground.Tornadoes can: Happen anytime and anywhere; Bring intense winds,over 321 KM;and Look like funnels.",
      "preparation": [
      ...
      "during": [
        ...
        "Listen Weather Radio, or local alerting systems for current emergency information and instructions.",
    ...
    wildfire: {
            ...
            "during": [
              ...
              "If trapped, then call 000 and give your location, but be aware that emergency response could be delayed or impossible. Turn on lights to help rescuers find you.",
    ...
    volcano: {
            ...
            "before": [
              ...
              "Learn about community warning systems. The Volcano Notification Service (VNS) is a free service that sends notifications about volcanic activity. ",
